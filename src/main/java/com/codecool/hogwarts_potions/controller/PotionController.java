...
public class PotionController {
    ...
    public List<Potion> getPotionsByStudent(@PathVariable("student_id") Long student_id) throws NotFoundException {
        return potionService.getPotionsByStudent(student_id);
    }

    @PostMapping("/brew/{student_id}")
    public Potion addPotion(@RequestBody Potion potion, @PathVariable("student_id") Long student_id) throws NotFoundException {
        return potionService.addPotion(potion, student_id);
    }

    @PutMapping("/{potion_id}/add")
    public Potion updatePotion(@PathVariable("potion_id") Long potion_id, @RequestBody Ingredient ingredient) throws NotFoundException {
